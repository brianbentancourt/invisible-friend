...
export const pagesEn = [
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                a: 'Payments are processed by MercadoPago, which accepts credit and debit cards (including international ones), bank transfers and account balance depending on the country.',
            },
            {
                q: 'Can I pay from outside Latin America?',
                a: 'Yes. The price is charged in Uruguayan pesos because our account is Uruguayan, but MercadoPago accepts cards issued in other countries and your bank handles the conversion automatically.',
            },
            {
        ...
        sections: [
            ...
            },
            {
                ...
                ul: [
                    ...
                    'MercadoPago: payment processing. We never store card details.',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                p: [
                    'The free plan allows draws of up to 15 participants. Paid plans are charged once through MercadoPago and unlock the features described on the pricing page.',
