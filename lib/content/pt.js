...
export const pagesPt = [
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                a: 'Você pode escolher entre MercadoPago e PayPal. O MercadoPago aceita cartões de crédito e débito, transferências e saldo em conta conforme o país. O PayPal está disponível em mais de 200 países e permite pagar com cartão internacional, tendo ou não uma conta PayPal.',
            },
            {
                q: 'Posso pagar do Brasil?',
                a: 'Sim. Fora da América Latina o PayPal costuma ser mais simples: a cobrança é feita em dólares (USD) e funciona com cartões de quase qualquer país. Com o MercadoPago o valor é cobrado em pesos uruguaios porque nossa conta é uruguaia, e o seu banco faz a conversão automaticamente.',
            },
            {
        ...
        sections: [
            ...
            },
            {
                ...
                ul: [
                    ...
                    'MercadoPago e PayPal: processamento de pagamentos. Não armazenamos dados de cartão.',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                p: [
                    'O plano grátis permite sorteios de até 15 participantes. Os planos pagos são cobrados uma única vez pelo MercadoPago (em UYU) ou pelo PayPal (em USD), à escolha do usuário, e liberam os recursos descritos na página de preços.',
