...
export const pagesEs = [
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                a: 'Procesamos los pagos con MercadoPago, que acepta tarjetas de crédito y débito (incluidas tarjetas internacionales), transferencias y saldo en cuenta según el país.',
            },
            {
                q: '¿Puedo pagar si estoy fuera de Uruguay?',
                a: 'Sí. El precio se cobra en pesos uruguayos porque nuestra cuenta es uruguaya, pero MercadoPago acepta tarjetas emitidas en otros países y tu banco hace la conversión automáticamente.',
            },
            {
        ...
        sections: [
            ...
            },
            {
                ...
                ul: [
                    ...
                    'MercadoPago: procesamiento de pagos. No almacenamos datos de tarjetas.',
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                h2: 'Planes y pagos',
                p: [
                    'El plan gratuito permite sorteos de hasta 15 participantes. Los planes de pago se cobran por única vez mediante MercadoPago y desbloquean las funciones descritas en la página de precios.',
